  ...
  DecimalFormat df = new DecimalFormat("##.##");
	...
	public GradientEditor(DesktopPane father, JDialog m, int o) {		
	    ...
	    okButton.addActionListener(new ActionListener() {
	        public void actionPerformed(ActionEvent e) {
	        	if (owner==LINE) parent.cp.linePanel.colorRampList.setSelectedIndex(comboBox.getSelectedIndex());
	        	if (owner==POINT) parent.cp.pointPanel.colorRampList.setSelectedIndex(comboBox.getSelectedIndex());
	        	if (owner==VECTOR) parent.cp.vectorPanel.colorRampList.setSelectedIndex(comboBox.getSelectedIndex());
