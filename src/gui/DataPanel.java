...
public class DataPanel extends JPanel implements ActionListener {
	...
	public DataPanel(DesktopPane father) {
		parent = father;
		setLayout(new MigLayout("", "[433.00:n,grow][][]", "[][][200px:n,grow][20px:n][][200px:n,grow][20px:n][][][][][grow][grow]"));	
		...
		fieldsTable = new JTable(fieldModel)
		{
			public Component prepareRenderer(TableCellRenderer renderer, int row, int column)
			{
				...
				if (!isRowSelected(row))
				{
					...
					if (type){ c.setBackground(Color.LIGHT_GRAY);					
					} else {
		...
		hoursSpinner.setModel(new SpinnerNumberModel(new Integer(0), new Integer(0), new Integer(1000), new Integer(1)));
		...
		minutesSpinner.setModel(new SpinnerNumberModel(new Integer(0), new Integer(0), new Integer(1000), new Integer(1)));
		...
		secondsSpinner.setModel(new SpinnerNumberModel(new Integer(0), new Integer(0), new Integer(1000), new Integer(1)));
	...
	public void checkSpinners(){
        if ( ((Integer) hoursSpinner.getValue() == 0) && ((Integer) minutesSpinner.getValue() == 0) && ((Integer) secondsSpinner.getValue() == 0) ) {
    ...
    public void openData() {
        ...
        FileNameExtensionFilter filter = new FileNameExtensionFilter("MoveBank Formatted CSV or TXT", "CSV", "csv", "TXT", "txt");
	...
	private void doIt() {
		...
		Period period = new Period((Integer) hoursSpinner.getValue(),(Integer) minutesSpinner.getValue(),(Integer) secondsSpinner.getValue(),0);
