...
public class SketchData {
	...
	public ArrayList<PointRecord> Bdy_hull = new ArrayList<PointRecord>();	//storing all the points that forming the convex hull
	...
	//setting for enable the time selection of the time line with boundary visualization
	...
	public ArrayList<Integer> visitedPoints= new ArrayList<Integer>();	//int array for indicating if the point visit the boundary
	...
	public ArrayList<PointRecord> hull = new ArrayList<PointRecord>();	//storing all the points that forming the convex hull
	...
	//Interactions variables
		...
		public boolean upToDate=false;//is false if user has changed selections since last pressing Generate Buffer button
		public ArrayList<PointRecord> interactingPoints;//boolean array of all all points, true if interacting, false if otherwise
